...
export default function AdsHelp() {
  ...
  // 🔥 intensity beda antara light & dark
  const glowMid = useColorModeValue(
    // LIGHT → lebih tebel (double layer)
      ...
      >
        ...
        >
          ...
          <ModalHeader color={modalText}>
            {t.adsHelpTitle || "Informasi Iklan"}
          </ModalHeader>
          ...
          <ModalBody>
            <VStack align="start" spacing={4}>
              ...
              >
                <Text fontSize="lg" fontWeight="extrabold" mb={4} color={modalText}>
                  {t.adsHelpSubtitle || "Cara kerja iklan di MogeHub"}
                </Text>

                <Text fontSize="md" color={modalSubText} lineHeight="1.7" whiteSpace="pre-line">
                    {t.adsHelpDesc}
                    </Text>
              </Box>
            </VStack>
